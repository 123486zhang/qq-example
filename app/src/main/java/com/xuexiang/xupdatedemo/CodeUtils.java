...
public class CodeUtils {
    ...
    private static final int BASE_PADDING_TOP = 30;//上边距
    private static final int RANGE_PADDING_TOP = 15;//上边距范围值
    private static final int DEFAULT_WIDTH = 160;//默认宽度.图片的总宽
    private static final int DEFAULT_HEIGHT = 60;//默认高度.图片的总高
    private static final int DEFAULT_COLOR = Color.rgb(0x96, 0xe5, 0x96);//默认背景颜色值
